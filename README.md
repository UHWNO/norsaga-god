...
| 🚢 **Live Vessels**         | Thousands of ships worldwide, enriched with Norwegian Coastal Administration terrestrial, offshore and satellite AIS around Norway, Svalbard and Jan Mayen when configured                                                                                                                                                                                                          | AISStream + BarentsWatch                 | 🟡                                                                                                  |
...
| **🟡 The free-key tier** | **$0 with a signup.** AISStream, BarentsWatch, FIRMS, TomTom, OpenSky, plus Cesium ion for eligible personal/non-commercial use. Provider quotas, coverage limits and eligibility still apply.                                                                                                                                                                             |
